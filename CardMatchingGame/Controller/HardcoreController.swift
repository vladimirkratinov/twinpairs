//
//  HardcoreController.swift
//  CardMatchingGame
//
//  Created by Vladimir Kratinov on 2022-09-05.
//
...
class HardcoreController: UIViewController {
    ...
    override func loadView() {
        ...
        gameInterface.difficultylabel.text = "HARDCORE"
...
//            try? audioFX.playFX(file: AudioFileKey.flip2.rawValue, type: AudioTypeKey.wav.rawValue)
        ...
        if prop.cardCounter == 2 {
            ...
            for card in Properties.cardButtons {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + prop.syncDisableAnimation - prop.hardcoreReduceTime) {
...
//                    try? self.audioFX.playGameStateFX(file: AudioFileKey.matchIgnite.rawValue, type: AudioTypeKey.wav.rawValue)
                ...
                //timer to show both cards:
                DispatchQueue.main.asyncAfter(deadline: .now() + prop.timeToShowBothCards - prop.hardcoreReduceTime) {
                    //audioFX:
